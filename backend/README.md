...
## Project Structure
    ...
    ├── tst_daniel_gh_invit_76503  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_gh_invit_76503`
...
2. Clone this repo and `cd tst_daniel_gh_invit_76503`
