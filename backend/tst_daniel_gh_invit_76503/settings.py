"""
Django settings for tst_daniel_gh_invit_76503 project.
...
ROOT_URLCONF = 'tst_daniel_gh_invit_76503.urls'
...
WSGI_APPLICATION = 'tst_daniel_gh_invit_76503.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_daniel_gh_invit_76503 API",
    "DESCRIPTION": "API documentation for tst_daniel_gh_invit_76503 App",
    "VERSION": "v1",
}
